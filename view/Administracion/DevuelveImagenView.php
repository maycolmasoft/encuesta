...
$image = "";
$conn =  pg_connect("host=localhost port=5432 dbname=encuestas_2023 user=postgres password=Fcpc.2021");
...
else 
{
		...
		if (!empty($res))
		{
				...
				{
					$archivo=$_SERVER['DOCUMENT_ROOT'].'/encuesta/view/images/'.'nodisponible.jpg';
