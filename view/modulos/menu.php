         ...
         <li class="treeview"  style="<?php echo getcontrolador("MenuEncuestas",$controladores) ?>"  >
          ...
          <ul class="treeview-menu">
             <li class="treeview"  style="<?php echo getcontrolador("MenuEncuestasProcesos",$controladores) ?>"  >
                  ...
                  <ul class="treeview-menu">
                 	 <li style="<?php echo getcontrolador("Encuestas",$controladores) ?>"><a href="index.php?controller=Encuesta&action=index"><i class="fa fa-circle-o"></i> Registrar Encuesta</a></li>
                  </ul>
                </li>
             
           <!--  <li class="treeview"  style="<?php echo getcontrolador("MenuEncuestasConsultas",$controladores) ?>"  >
                  <a href="#">
