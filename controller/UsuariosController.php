	...
	public function InsertaUsuarios(){
		...
		if (isset(  $_SESSION['nombre_usuarios']) )
		{
    		...
    		if (isset ($_POST["cedula_usuarios"]))
    		{
    		    ...
    		    {
    		        $directorio = $_SERVER['DOCUMENT_ROOT'].'/encuesta/fotografias_usuarios/';
	...
	public function resetear_clave_inicio()
	{
		...
		if (isset($_POST['cedula_usuarios']))
		{
			...
			else
			{
				...
				$asunto="Claves de Acceso Encuestas";
				$fecha=date("d/m/y");
				$hora=date("H:i:s");
				...
				<p><table rules='all'></p>
				<tr style='background:#1C1C1C'><td WIDTH='1000' HEIGHT='50' align='center'><font color='white'>Encuestas - <a href='http://www.google.com.ec'><FONT COLOR='#7acb5a'>www.encuestas.com.ec</FONT></a> - Copyright © 2022-</font></td></tr>
				</table>
				";
	
	
				if(mail("$destino","Claves de Acceso Encuestas","$resumen","$cabeceras"))
				{
