...
class Conectar{
    ...
    public function conexion(){
        ...
        if($this->driver=="pgsql" || $this->driver==null){
             ...
             $con = pg_connect("host=localhost port=5432 dbname=encuestas_2023 user=postgres password=Fcpc.2021");
    ...
    public function startFluent(){
        ...
        if($this->driver=="pgsql" || $this->driver==null){
        	...
        	try
        	{
		        $pdo = new PDO('pgsql:host=localhost;port=5432;dbname=encuestas_2023', 'postgres', 'Fcpc.2021' );
